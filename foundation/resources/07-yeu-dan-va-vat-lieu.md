# Yêu đan & vật liệu phụ (妖丹与辅材)

**Tham chiếu:** Core §3.4; Luật 1 (Yêu khí), Luật 4 ( săn yêu / nuốt đan).

## Yêu đan theo nguồn

| Tên / loại | Nguồn | Phẩm (ước) | Công dụng | Cảnh giới dùng | Hiếm | Trade-off / Nghiệp |
| --- | --- | --- | --- | --- | --- | --- |
| **Lang nha đan** (狼牙丹) — yêu lang | Yêu lâm ngoại vi | Hạ | Luyện Khí tăng khí | LK 1–6 | Thấp | Yêu khí nhẹ |
| **Xích Xà nội đan** (赤蛇内丹) `[bổ sung sáng tác]` | Vực độc | Trung | Giải độc / đan độc | LK–Trúc Cơ | TB | Sai luyện → độc |
| **Thiên Hồ yêu đan** (天狐妖丹) `[bổ sung sáng tác]` | Yêu tộc cao | Trung–Thượng | Hồn phách / ảo thuật phù | Trúc Cơ–Kim Đan | Cao | Nuốt trực tiếp → tâm ma |
| **Kim Đan yêu tương đương** (≈ human Kim Đan) `[nguồn power]` | Yêu thú Kim Đan kỳ | Cao | Ngưng đan phụ; luyện khí | Kim Đan đan sư | Cao | Nhân-yêu huyết hận |
| **Nguyên Anh yêu đan** `[nguồn power]` | Yêu vương sơ | Cực | Đột phá / Cổ bảo | Nguyên Anh | Rất cao | Truy sát tộc |
| **Yêu Vương nội đan** (妖王内丹) `[nguồn power]` | Yêu Vương | Thượng–Cực | Đan phương cao; Ma nuốt | Hóa Thần sơ (Ma) | Cực hiếm | **Nghiệp** nặng; Luật 4 |
| **Long tủy / Phượng linh** (龙髓/凤灵) sketch `[bổ sung sáng tác]` | `(bí mật)` tộc cổ | Chí tài nguyên | Luyện Tiên bảo mảnh | Hóa Thần+ | Huyền thoại | Cả giới tranh |

## Vật liệu phụ (linh vật)
...
| **Phượng vũ** (凤羽) sketch `[bổ sung sáng tác]` | `(bí mật)` | Lò đan / phù hỏa cao | Đan sư tứ phẩm+ | Cực hiếm | — |
| **Quỷ lệnh châu** (鬼灵珠) `[bổ sung sáng tác]` | Cấm địa quỷ tu | Ma pháp bảo | Ma đạo | Cao | Ma khí ô nhiễm (Luật 1) |
| **Linh sa** (灵砂) `[bổ sung sáng tác]` | Mỏ phụ; sông linh | Mực phù; trận nhỏ | Phù sư | TB | — |
| **Da yêu cấp phù** (符皮) `[bổ sung sáng tác]` | Yêu thú đặc biệt | Phù trung trở lên | Phù sư | Cao | Săn yêu |
...
| **Biến động** | Ép giá theo người, **trận giật**, Sa Điêu **monopoly suất**; tán tu không nộp danh bị cắt thêm |

## Vòng kinh tế (tóm)

```text
Săn yêu / linh thú → yêu đan & phụ liệu → đan phương / phù / luyện khí
                  ↘ hắc thị Ma (nuốt đan) → Nghiệp → kiếp nặng sau
```

**Monopoly:** Tông **sủng thú viện** kiểm soát linh thú huyết hợp pháp; yêu đan cao = **chiến tranh biên giới** Yêu Giới (Luật 6).

**Tổng mục:** 7 loại yêu đan chính + 10 vật liệu phụ.
