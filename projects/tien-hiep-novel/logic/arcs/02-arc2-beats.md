# Arc 2 — Tranh Mạch Phụ — Beat sheet (Logic)

> **Neo:** `logic/arcs/00-arc-master-outline.md` · `logic/arcs/01-arc1-beats.md` · `logic/foreshadowing/00-foreshadow-ledger.md`  
> **Quy mô:** Cấp **III** (Khu vực / Đa tông), xen **II** (hub thành trì).  
> **Cảnh giới:** Trúc Cơ **Sơ → Trung**; Tâm ma **mầm** (không thành ma quỷ). **~34 chương** (ch. 55–88).
...
## Pacing & event scale (Arc 2)

| Giai đoạn | % arc (~) | Quy mô | Loại sự kiện (`01-event-scale` §2) |
| --- | --- | --- | --- |
| Beat 1–2 (2A) | ~25% | **III** mở | Tông tranh **linh mạch phụ**; thuê tán tu |
| Beat 3–5 (2B) | ~35% | **III** | Bí cảnh chung vé; Sát Thủ; **bi kịch wound** |
| Beat 6–8 (2C) | ~25% | **III** | Mạch đoạn; Ma lậu; Nhân-Quả vùng |
| Beat 9–10 | ~15% | III → hub **II** | Linh Dịch lệch; setup hiệp hội đan |
...
| Hạng mục | Quyết định |
| --- | --- |
| **NC / tam giác** | Vẫn **trì hoãn** — khách thuê sát **không** romance; có thể **mở NC mầm cuối Arc 2 / Arc 3** (FS-017) |
| **Vào tông** | MC **không** làm đệ tử chính thức — vẫn **tán tu thuê** |
| **Vượt cấp** | Không solo hạ **Kim Đan**; Trúc Cơ Trung vs Kim Đan = trận + suy yếu + thuê |
| **Heal wound** | **Không** — chỉ **đâm sâu hơn** (Beat 5) |
| **Lore Thượng cổ** | **Không** payoff đầy **Cửu Huyền Cổ Phong** — chỉ nurture **FS-001/015** |
