...
> **Neo:** `foundation/core/01–03`, `foundation/logic/01-event-scale-system.md`, `projects/tien-hiep-novel/00-master-brief.md` v2.  
> **Tên canon:** placeholder đến khi `interface/naming/registry.md` (T3).
