# Master Brief — Tiên Hiệp Novel — v2 — 2026-09-07
...
| Trường              | Giá trị                                       |
| ------------------- | --------------------------------------------- |
| **work_slug**       | `tien-hiep-novel`                             |
| **work_root**       | `projects/tien-hiep-novel/`                   |
| **foundation_root** | `foundation/` *(shared — Core tại repo root)* |
| **logic_root**      | `projects/tien-hiep-novel/logic/`             |
| **interface_root**  | `projects/tien-hiep-novel/interface/`         |
...
| **Định dạng output** | Markdown dưới `projects/tien-hiep-novel/interface/` |
...
| --- | --- | --- |
| Master Brief | `projects/tien-hiep-novel/00-master-brief.md` | requirements-briefer |
| **Progress map** | `projects/tien-hiep-novel/00-progress-map.md` | project-orchestrator / user session |
| Execution plan | `projects/tien-hiep-novel/01-execution-plan.md` | user / orchestrator |
| Story spine | `projects/tien-hiep-novel/logic/00-story-spine.md` | project-orchestrator |
| Chapter spine | `projects/tien-hiep-novel/logic/chapters/00-chapter-spine-phase1.md` | project-orchestrator |
| Mục lục chương | `projects/tien-hiep-novel/interface/chapters/00-index.md` | project-orchestrator |
| Trạng thái | `projects/tien-hiep-novel/status.md` | project-orchestrator |
| Core (shared) | `foundation/core/00–03` | Foundation agents |
| Arc outline | `projects/tien-hiep-novel/logic/arcs/00-arc-master-outline.md` | arc-planner |
| Foreshadow ledger | `projects/tien-hiep-novel/logic/foreshadowing/00-foreshadow-ledger.md` | foreshadowing-architect |
| Tên canon | `projects/tien-hiep-novel/interface/naming/registry.md` | xianxia-naming-specialist |
| Chương | `projects/tien-hiep-novel/interface/chapters/` | xianxia-prose-writer |
...
- Core tại `foundation/` là Canon cho tác phẩm này đến khi user yêu cầu Foundation pass hoặc tách `projects/tien-hiep-novel/foundation/`.
...
- **v1 (2026-09-07):** Khung khởi tạo; chuyển từ `project/` → `projects/tien-hiep-novel/`.
