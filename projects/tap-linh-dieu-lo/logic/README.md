# Logic Layer — Tạp Linh Diêu Lộ · `tap-linh-dieu-lo`

> **Thứ tự đọc / chỉnh sửa (Foundation → Logic → Interface):**  
> Brief → **Story spine** → **Arc outline** → **Chapter spine** → Beat sheet → Foreshadow ledger → Naming → Prose.
...
**Quy tắc orchestrator:** Không viết chương prose mới nếu chưa có dòng trong `chapters/00-chapter-spine-phase1.md`. **Cuối session:** cập nhật [`../00-progress-map.md`](../00-progress-map.md).
