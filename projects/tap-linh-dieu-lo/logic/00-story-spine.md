...
> **Tác phẩm:** **Tạp Linh Diêu Lộ** (杂灵遥路) · **Slug:** `tap-linh-dieu-lo` · **Brief:** v3 · **Trần phase 1:** **Trúc Cơ kỳ đỉnh phong**  
...
| **Beat Arc 3** | [`arcs/03-arc3-beats.md`](./arcs/03-arc3-beats.md) | 10 beat ↔ ch 89–112 |
